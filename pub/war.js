...
var ASM_CONSTS = {
  87224: () => { if (document.fullscreenElement) return 1; },  
 87270: () => { return document.getElementById('canvas').width; },  
 87322: () => { return parseInt(document.getElementById('canvas').style.width); },  
 87390: () => { document.exitFullscreen(); },  
 87417: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 87490: () => { if (document.fullscreenElement) return 1; },  
 87536: () => { return document.getElementById('canvas').width; },  
 87588: () => { return screen.width; },  
 87613: () => { document.exitFullscreen(); },  
 87640: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 87773: () => { if (document.fullscreenElement) return 1; },  
 87819: () => { return document.getElementById('canvas').width; },  
 87871: () => { return parseInt(document.getElementById('canvas').style.width); },  
 87939: () => { if (document.fullscreenElement) return 1; },  
 87985: () => { return document.getElementById('canvas').width; },  
 88037: () => { return screen.width; },  
 88062: () => { if (document.fullscreenElement) return 1; },  
 88108: () => { return document.getElementById('canvas').width; },  
 88160: () => { return screen.width; },  
 88185: () => { document.exitFullscreen(); },  
 88212: () => { if (document.fullscreenElement) return 1; },  
 88258: () => { return document.getElementById('canvas').width; },  
 88310: () => { return parseInt(document.getElementById('canvas').style.width); },  
 88378: () => { document.exitFullscreen(); },  
 88405: () => { return screen.width; },  
 88430: () => { return screen.height; },  
 88456: () => { return window.screenX; },  
 88483: () => { return window.screenY; },  
 88510: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 88563: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 88634: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 88691: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 88762: () => { if (document.fullscreenElement) return 1; },  
 88808: () => { if (document.pointerLockElement) return 1; }
};
